...
count = Label(root,text=0,font=100,bg="black",fg="white")
...
count_indica = Label(root,font=50,text="TRIES",bg="black",fg="white")
...
rock = Button(root,width=20,height=2,text="ROCK",bg="black",fg="white",command=lambda:func(0)).grid(row=3,column=1)
paper = Button(root,width=20,height=2,text="PAPER",bg="black",fg="white",command=lambda:func(1)).grid(row=3,column=2)
sciss = Button(root,width=20,height=2,text="SCISSORS",bg="black",fg="white",command=lambda:func(2)).grid(row=3,column=3)
